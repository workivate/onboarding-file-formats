...
------------------  |---------------------------------------------------------------------------------|---------------------------------------------------------------|----------------------------------------------------------------------------|--------------------------------------|--------------------------------------| --------------------------------
 ...
 ~~activation_date~~    | ~~User activation date~~                                                            | ~~Date from which account should be active in ISO 8601 format~~   | ~~2018-10-23~~                                                                 | ~~False~~                                | ~~False~~                                | ~~Default current date if empty~~ **NOT IN USE**
 ...
 otp                | One time password, provided by the employer, which has to be confirmed by user  | Min length 5 Max length 32                | abc-ABC,12345                                                                 | False                                | False                                | Only letters and numbers "/" and "-"
 ...
 ~~restricted_access~~                | ~~Indicates whether the users from outside of a given region should be restricted from accessing the platform~~                    | ~~Choice: yes, no~~                                               | ~~yes~~                                                                        | ~~False~~                                | ~~False~~                                | **NOT IN USE**
